...
export declare const getClassName: (node: Node) => string | undefined;
export declare const getDecorator: (node: ClassDeclaration, decoratorName: string) => Decorator | undefined;
export declare const getDecoratorArgument: (decorator: Decorator) => ObjectLiteralExpression | undefined;
export declare const getDecoratorName: (decorator: Decorator) => string | undefined;
export declare const getDecoratorPropertyInitializer: (decorator: Decorator, name: string) => Expression | undefined;
export declare const getNextToLastParentNode: (node: Node) => Node;
export declare const getComponentDecorator: (node: ClassDeclaration) => Decorator | undefined;
export declare const getDirectiveDecorator: (node: ClassDeclaration) => Decorator | undefined;
export declare const getInjectableDecorator: (node: ClassDeclaration) => Decorator | undefined;
export declare const getNgModuleDecorator: (node: ClassDeclaration) => Decorator | undefined;
export declare const getPipeDecorator: (node: ClassDeclaration) => Decorator | undefined;
...
export declare const getDeclaredInterfaceName: (node: ClassDeclaration, value: string) => string | undefined;
export declare const getDeclaredAngularLifecycleInterfaces: (node: ClassDeclaration) => ReadonlyArray<AngularLifecycleInterfaceKeys>;
...
export declare const getDeclaredAngularLifecycleMethods: (node: ClassDeclaration) => ReadonlyArray<AngularLifecycleMethodKeys>;
